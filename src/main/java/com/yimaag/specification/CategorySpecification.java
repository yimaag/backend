...
public class CategorySpecification implements Specification<Category> {
    ...
    private void sort(Root<Category> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder builder) {
        ...
        for (String value : values) {
            ...
            if (sortParam.equals("visibility")) {
                if (sortType.equals("asc")) {
                    orders.add(builder.asc(root.get("visibility")));
                } else {
                    orders.add(builder.desc(root.get("visibility")));
                }
            }
        }
