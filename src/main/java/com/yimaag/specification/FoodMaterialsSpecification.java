...
@NoArgsConstructor
@AllArgsConstructor
public class FoodMaterialsSpecification implements Specification<FoodMaterials> {
    private SearchCriteria criteria;

    @Override
    public Predicate toPredicate(Root<FoodMaterials> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
    ...
    private void sort(Root<FoodMaterials> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder builder) {
